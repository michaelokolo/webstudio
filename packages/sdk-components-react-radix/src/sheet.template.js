...
exports.meta = {
  ...
  order: 1,
  template: (
    <proxy_1.radix.Dialog ws:label="Sheet">
      <proxy_1.radix.DialogTrigger ws:label="Sheet Trigger">
        <template_1.$.Button
          ws:style={(0, styles_1.getButtonStyle)("ghost", "icon")}
        >
      ...
      >
        ...
        >
          <template_1.$.Box ws:label="Navigation" ws:tag="nav">
            <template_1.$.Box
            ...
            >
              ...
              >
                {new template_1.PlaceholderValue("Sheet Title")}
              </proxy_1.radix.DialogTitle>

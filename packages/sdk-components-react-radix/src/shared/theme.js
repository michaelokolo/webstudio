...
exports.width = __assign(__assign({}, exports.spacing), { full: "100%" });
exports.height = __assign(__assign({}, exports.spacing), { full: "100%" });
exports.maxWidth = {
  0: "0rem",
  xs: "20rem",
  sm: "24rem",
...
exports.boxShadow = {
  ...
  ring:
    "0 0 0 "
      .concat(ringOffsetWidth[2], " ")
      .concat(exports.colors.background, ", ") +
    "0 0 0 calc("
      .concat(ringWidth[2], " + ")
      .concat(ringOffsetWidth[2], ") ")
      .concat(exports.colors.ring),
};
exports.zIndex = {
  0: "0",
  10: "10",

...
exports.Tooltip = (0, react_1.forwardRef)(function (props, _ref) {
  var _a;
 ...
 */
exports.TooltipTrigger = (0, react_1.forwardRef)(function (_a, ref) {
...
exports.TooltipContent = (0, react_1.forwardRef)(function (_a, ref) {
  var _b = _a.sideOffset,
    sideOffset = _b === void 0 ? 4 : _b,
    _c = _a.hideWhenDetached,
    hideWhenDetached = _c === void 0 ? true : _c,
    props = __rest(_a, ["sideOffset", "hideWhenDetached"]);
  return (
...
exports.hooksTooltip = {
  onNavigatorUnselect: function (context, event) {
    for (var _i = 0, _a = event.instancePath; _i < _a.length; _i++) {
      var instance = _a[_i];
      if (instance.component === "".concat(namespace, ":TooltipContent")) {
        var tooltip = (0, runtime_1.getClosestInstance)(
          event.instancePath,
          instance,
